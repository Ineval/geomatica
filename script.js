const SUPABASE_URL = "https://apiqfherndzzulzwrryq.supabase.co";
    ...
    function activarMinimizarPaneles() {
      const toggleStatsBtn = document.getElementById('toggleStatsBtn');
      const toggleLegendBtn = document.getElementById('toggleLegendBtn');
      const legendBox = document.getElementById('legendBox');

      if (toggleStatsBtn && statsBox) {
        toggleStatsBtn.setAttribute('type', 'button');
      ...
      if (toggleLegendBtn && legendBox) {
        toggleLegendBtn.setAttribute('type', 'button');
